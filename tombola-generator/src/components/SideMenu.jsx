...
function SideMenu({ isOpen, onClose, soldRanges, onRangesChange, availableCount }) {
      ...
      <div className={`side-menu ${isOpen ? 'open' : ''}`}>
        ...
        <div className="side-menu-content">
          <div className="info-box">
            <p><strong>Available Tickets:</strong> {availableCount}</p>
                ...
                <div key={variant} className="range-input-group">
                  <label>
                    ...
                    <input
                      ...
                      onChange={(e) => handleRangeChange(color, variant, e.target.value)}
